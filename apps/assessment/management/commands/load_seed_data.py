...
from apps.assessment.models import Module, Milestone, EfficiencyThreshold, BonusCategory, SupervisorTip, GradeDescriptor


MODULES = [
    {"id": "primer", "title": "PLC Boot Camp", "type": "lesson", "html_file": "plc-primer.html", "difficulty": 0, "description": "25-term glossary, 6 learning tools, and 6 beginner video resources. Start here.", "role_title": None, "sort_order": 0},
    {"id": "multimeter", "title": "Digital Multimeter Tool", "type": "tool", "html_file": "multimeter.html", "difficulty": 1, "description": "Interactive DMM simulator with rotary dial, probe placement, and 4 fault-finding scenarios.", "role_title": None, "sort_order": 1},
    {"id": "multimeter-lesson", "title": "Multimeter Lesson", "type": "lesson", "html_file": "multimeter-lesson.html", "difficulty": 1, "description": "7-section lesson covering DMM anatomy, CAT ratings, measurement procedure, safety, and a quiz.", "role_title": None, "sort_order": 2},
    {"id": "level1", "title": "Start/Stop Latching Circuit", "type": "challenge", "html_file": "level1.html", "difficulty": 1, "description": "Seal-in latch, NC contacts, E-Stop fail-safe design, and the PLC scan cycle.", "role_title": "Automation Technician \u2013 Tier 1", "sort_order": 3},
    {"id": "learn-your-log", "title": "Learn Your Log", "type": "lesson", "html_file": "learn-your-log.html", "difficulty": 1, "description": "Why maintenance logs matter, 8 required fields, ISO 9001, and a spot-the-mistake exercise.", "role_title": None, "sort_order": 4},
    {"id": "maintenance-log", "title": "Maintenance Log Template", "type": "tool", "html_file": "maintenance-log.html", "difficulty": 1, "description": "Full structured log form: 8 sections, parts table, safety checklist, and print view.", "role_title": None, "sort_order": 5},
    {"id": "level2", "title": "Tank Filling System", "type": "challenge", "html_file": "level2.html", "difficulty": 2, "description": "Process control with NO/NC sensors, seal-in latch, hysteresis, and fail-safe fault injection.", "role_title": "Process Control Technician \u2013 Tier 1", "sort_order": 6},
    {"id": "level3", "title": "Modbus TCP Communication", "type": "challenge", "html_file": "level3.html", "difficulty": 3, "description": "MBAP header, function codes FC01/03/04/05/06/16, request builder, and protocol log.", "role_title": "Industrial Networks Technician \u2013 Tier 2", "sort_order": 7},
    {"id": "level4", "title": "Safety Interlock \u2014 Drill Machine", "type": "challenge", "html_file": "level4.html", "difficulty": 4, "description": "Dual-channel E-Stop, guard gate, RESET acknowledgement, IEC 62061, PSSR 2000.", "role_title": "Functional Safety Engineer \u2013 IEC 62061", "sort_order": 8},
    {"id": "level5", "title": "Timed Conveyor \u2014 TON Instruction", "type": "challenge", "html_file": "level5.html", "difficulty": 4, "description": "Timer On-Delay instruction, EN/TT/DN bits, preset vs accumulated value, mid-cycle E-Stop.", "role_title": "Automation Technician \u2013 Tier 2", "sort_order": 9},
    {"id": "level6", "title": "Sequential Batching \u2014 State Machine", "type": "challenge", "html_file": "level6.html", "difficulty": 5, "description": "ISA-88 state machine, mutual exclusion, IDLE/FILL/MIX/DRAIN states, auto-cycle.", "role_title": "Process Automation Engineer \u2013 ISA-88", "sort_order": 10},
]
...
class Command(BaseCommand):
    help = 'Load seed data from create_db.py into Django ORM'
    ...
    def handle(self, *args, **options):
        if options['flush']:
            ...
            SupervisorTip.objects.all().delete()
            BonusCategory.objects.all().delete()
            EfficiencyThreshold.objects.all().delete()
            Milestone.objects.all().delete()
            GradeDescriptor.objects.all().delete()
        ...
        self.stdout.write('Loading milestones...')
        for module_id, milestones in MILESTONES.items():
        ...
        self.stdout.write('Loading efficiency thresholds...')
        for module_id, thr in EFFICIENCY_THRESHOLDS.items():
            EfficiencyThreshold.objects.update_or_create(
                module_id=module_id,
                defaults=thr
            )

        self.stdout.write('Loading bonus criteria...')
        for module_id, criteria in BONUS_CRITERIA.items():
            for bc in criteria:
                BonusCategory.objects.update_or_create(
                    module_id=module_id,
                    bonus_key=bc['key'],
                    defaults={
                        'label': bc['label'],
        ...
        self.stdout.write('Loading supervisor tips...')
        for module_id, tips in SUPERVISOR_TIPS.items():
            for tip in tips:
                SupervisorTip.objects.update_or_create(
                    module_id=module_id,
                    sort_order=tip['order'],
                    defaults={
                        'icon': tip['icon'],
                        'variant': tip['variant'],
                        'tip_text': tip['text'],
        ...
        self.stdout.write('Loading grade descriptors...')
        for gd in GRADE_DESCRIPTORS:
